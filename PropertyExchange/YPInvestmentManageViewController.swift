...
class YPInvestmentManageViewController: UIViewController {
  ...
  lazy var nothingView:YPNothingView = {
    ...
    _nothingView.model = (title:"暂无投资项目",image:UIImage(named:"无数据")!,operationTitle:"去投资",controller:YPProjectInverstmentViewController.self)
    return _nothingView
  }()
