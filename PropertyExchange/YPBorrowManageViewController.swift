...
class YPBorrowManageViewController: UIViewController {
  ...
  lazy var nothingView:YPNothingView = {
    ...
    _nothingView.model = (title:"暂无借款项目",image:UIImage(named:"无数据")!,operationTitle:"去借款",controller:YPBorrowController.self)
    return _nothingView
  }()
