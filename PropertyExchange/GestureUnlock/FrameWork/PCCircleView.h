 ...
 *  手势密码界面用途类型
 */
typedef NS_ENUM(NSUInteger, CircleViewType) {
 ...
 *  @param gesture 手势结果
 */
- (void)circleView:(nonnull PCCircleView *)view type:(CircleViewType)type connectCirclesLessThanNeedWithGesture:(nonnull NSString *)gesture;
...
- (nonnull instancetype)initWithType:(CircleViewType)type clip:(BOOL)clip arrow:(BOOL)arrow;
